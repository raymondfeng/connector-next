...
[![Travis Build Status](https://travis-ci.org/strongloop/connector-next.svg?branch=master)](https://travis-ci.org/strongloop/connector-next)
[![AppVeyor Build status](https://ci.appveyor.com/api/projects/status/q8vp7wrdn2ak6801/branch/master?svg=true)](https://ci.appveyor.com/project/strongloop/connector-next/branch/master)
[![Coverage Status](https://coveralls.io/repos/github/strongloop/connector-next/badge.svg?branch=master)](https://coveralls.io/github/strongloop/connector-next?branch=master)
[![Greenkeeper badge](https://badges.greenkeeper.io/strongloop/connector-next.svg)](https://greenkeeper.io/)
...
[issue #110](https://github.com/strongloop/connector-next/issues/110).
...
See
[all contributors](https://github.com/strongloop/connector-next/graphs/contributors).
